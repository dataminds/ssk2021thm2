...
pcor_df %>% plot(
  main = "Gaussian Graphical Models for Partial Correlations",
  asp = 1.3:1) 
...
---
name: results2a
# 결과: 가설2a: 대면소통/미디어이용 - 고립/소속연결감 - 불안녕감
...
---
name: results2b
# 결과: 가설2b: 대면소통/미디어이용 - 고립/소속연결감 - 안녕감
...
---
name: results3a1
# 결과: 가설3a1: 대면소통-고립감-불안녕감: 관계이용 조절매개
...
for(i in seq_along(M)) {
  for (j in seq_along(Y)) {
    ...
    plot(med2_out, main = paste(X, "-", M[[i]], "-", Y[[j]], ":", I, "= Low", sep = " "))
    
    plot(med4_out, main = paste(X, "-", M[[i]], "-", Y[[j]], ":", I, "= Mid", sep = " "))
    
    plot(med6_out, main = paste(X, "-", M[[i]], "-", Y[[j]], ":", I, "= High", sep = " "))
...
---
name: results3a2
# 결과: 가설3a2: 대면소통-고립감-안녕감: 관계이용 조절매개
...
---
name: results3b1
# 결과: 가설3b1: 대면소통-고립감-불안녕감: 정보이용 조절매개
...
---
name: results3b2
# 결과: 가설3b2: 대면소통-고립감-안녕감: 정보이용 조절매개
...
---
name: results3c1
# 결과: 가설3c1: 대면소통-고립감-불안녕감: 오락이용 조절매개
...
---
name: results3c2
# 결과: 가설3c2: 대면소통-고립감-안녕감: 오락이용 조절매개
